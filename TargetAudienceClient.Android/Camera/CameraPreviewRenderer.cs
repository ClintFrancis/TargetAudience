...
using TargetAudienceClient.Droid;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(TargetAudienceClient.CameraPreview), typeof(CameraPreviewRenderer))]
namespace TargetAudienceClient.Droid
{
	public class CameraPreviewRenderer : ViewRenderer<TargetAudienceClient.CameraPreview, DroidCameraPreview>
	{
